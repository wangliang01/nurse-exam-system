    ...
    <div className="modern-card p-8 bg-white border-slate-200/60 shadow-xl shadow-slate-200/20">
      <div className="flex flex-col gap-6 mb-8">
        <div className="flex justify-between items-end">
          <div>
            <h3 className="font-black text-slate-800 text-xl tracking-tight uppercase">答题卡</h3>
            <p className="text-xs font-bold text-slate-400 mt-1 uppercase tracking-widest">题目矩阵</p>
          </div>
          <div className="flex flex-col items-end">
            ...
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">已完成</span>
          </div>
        </div>
      ...
      <div className="mt-10 pt-8 border-t border-slate-100 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-center gap-3">
             ...
             <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">已回答</span>
          </div>
          <div className="flex items-center gap-3">
             <div className="w-3 h-3 rounded-full bg-slate-200 border border-slate-300" />
             <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">待回答</span>
          </div>
        </div>
        ...
        <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
           <div className="flex items-center gap-2 text-indigo-600 mb-1">
             ...
             <span className="text-xs font-black uppercase tracking-widest">使用说明</span>
           </div>
           <p className="text-[10px] font-medium text-slate-500 leading-relaxed">
             点击题号可直接跳转。带有圆点的题号表示该题已经完成作答。
           </p>
        </div>
      </div>
    </div>
